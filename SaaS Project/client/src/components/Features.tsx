      ...
      <section id="features" className="py-20 2xl:py-32">
        <div className="max-w-6xl mx-auto px-4">
          <Title
            ...
            description="Create brand-ready content that feels authentic, not artificial. Our AI understands lighting, context, and style to deliver visuals that look real and perform better."
          />
