...
export const featuresData = [
  {
    ...
    title: "Smart Upload",
    desc: "Upload once, publish everywhere. Our AI handles sizing, formats, and quality.",
  },
  {
    icon: <ZapIcon className="w-6 h-6" />,
    title: "Instant Generation",
    desc: "Get studio-quality results in seconds with optimized AI models.",
  },
  {
...
export const faqData = [
    {
        ...
        answer: 'We leverage state-of-the-art diffusion models trained on million of product images to blend your product into realistic scenes while preserving detail, lighting and reflections'
    },
    {
